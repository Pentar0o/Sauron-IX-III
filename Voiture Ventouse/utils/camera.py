...
class Camera:
    ...
    """
    def __init__(self, dict_cam, time_dispappeared = 10) :
        ...
        self.start(time_dispappeared)

    def start(self, time_dispappeared):
        ...
        for i in range(1, nb_cam ):
            ...
            self.centroid_tracker.append(CentroidTracker(camera_name, time_dispappeared))
